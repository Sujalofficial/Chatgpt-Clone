    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="p-6 sm:p-8 space-y-8 sm:space-y-10 max-h-[70vh] overflow-y-auto">
          ...
          {/* Streaming toggle */}
          <div className="flex items-center justify-between p-5 sm:p-6 bg-slate-50 dark:bg-[#0f172a]/50 rounded-[1.75rem] border border-slate-200/50 dark:border-slate-800">
        ...
        <div className="p-6 sm:p-8 bg-slate-50/80 dark:bg-[#0f172a]/80 text-center border-t border-slate-100 dark:border-slate-800">
            <button onClick={onClose} className="w-full py-3.5 sm:py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-black rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all shadow-2xl uppercase tracking-widest text-xs">
              Commit Changes
            </button>
        </div>
      </div>
